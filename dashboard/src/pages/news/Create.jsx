                    ...
                    <form>
                        ...
                        <div className="block-section news-info">
                            <div className="input-section">
                                <p>Тема новости:</p>
                                <textarea name="" id="" placeholder="Введите тему новости" required value={title} onChange={(e) => setTitle(e.target.value)} ></textarea>
                            </div>
                            <div className="input-section">
                                <p>Текст новости:</p>
                                <textarea name="" id="" placeholder="Введите текст новости" required value={text} onChange={(e) => setText(e.target.value)} ></textarea>
                            </div>
                            <div className="input-section">
                                <p>Дата публицаии:</p>
